...
(def-doom-theme doom-one
  "Based on my custom .Xresources"

  ;; name        default   256       16
  ((bg         '("#2a2929" nil       nil            ))
   (bg-alt     '("#655c5a" nil       nil            ))
   (base0      '("#2a2929" "black"   "black"        ))
   (base1      '("#2a2929" "#1e1e1e" "brightblack"  ))
   (base2      '("#2a2929" "#2e2e2e" "brightblack"  ))
   (base3      '("#2a2929" "#262626" "brightblack"  ))
   (base4      '("#655c5a" "#3f3f3f" "brightblack"  ))
   (base5      '("#655c5a" "#525252" "brightblack"  ))
   (base6      '("#655c5a" "#6b6b6b" "brightblack"  ))
   (base7      '("#655c5a" "#979797" "brightblack"  ))
   (base8      '("#655c5a" "#dfdfdf" "white"        ))
   (fg         '("#e4e4e5" "#bfbfbf" "brightwhite"  ))
   (fg-alt     '("#89908f" "#2d2d2d" "white"        ))
