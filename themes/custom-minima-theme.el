...
(def-doom-theme doom-one
  ...
  ;; name        default   256       16
  ((bg         '("#2a2929" nil       nil            ))
   (bg-alt     '("#e4e4e5" nil       nil            ))
   (base0      '("#2a2929" "black"   "black"        ))
   (base1      '("#a54242" "#1e1e1e" "brightblack"  ))
   (base2      '("#60b48a" "#2e2e2e" "brightblack"  ))
   (base3      '("#de935f" "#262626" "brightblack"  ))
   (base4      '("#5f819d" "#3f3f3f" "brightblack"  ))
   (base5      '("#85678f" "#525252" "brightblack"  ))
   (base6      '("#5e8d87" "#6b6b6b" "brightblack"  ))
   (base7      '("#89908f" "#979797" "brightblack"  ))
   (base8      '("#655c5a" "#dfdfdf" "white"        ))
   (fg         '("#e4e4e5" "#bfbfbf" "brightwhite"  ))
   (fg-alt     '("#2a2929" "#2d2d2d" "white"        ))
